...
const ItineraryPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <Link
        to="/"
        className="flex items-center text-orange-500 mb-6 hover:text-orange-800"
      >
      ...
      <div className="mb-8 text-gray-700">
        <p className="text-lg font-semibold">
          {itineraryDetails.days} jours / {itineraryDetails.nights} nuits pour
          découvrir les quatre villes impériales
        </p>
      </div>
      ...
      <div className="mt-10 text-center">
        <Link to="/reservation" onClick={() => window.scrollTo(0, 0)}>
